...
# De-Time Component Pair Trading and Cointegration

<div class="gallery-note notebook-transcript-note">
  <strong>Rendered notebook transcript.</strong> This page is generated from <a href="https://github.com/systems-mechanobiology/De-Time/blob/main/examples/notebooks/quant_trading/04_detime_component_pair_trading_cointegration.ipynb"><code>examples/notebooks/quant_trading/04_detime_component_pair_trading_cointegration.ipynb</code></a> and includes code cells plus captured outputs from the committed notebook.
</div>
...
<img src="../../../../assets/generated/notebooks/columns/quant-trading/04_detime_component_pair_trading_cointegration/cell-006-output-01.png" alt="Notebook output cell 6" class="notebook-output-image">
</div>
</div>
